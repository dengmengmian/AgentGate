...
3. Open MuxLayer, go to **Providers**, and add a provider with type **GitHub Copilot**.
4. Paste the `gho_` or `ghu_` token as the API key. MuxLayer fills the base URL and model list.
