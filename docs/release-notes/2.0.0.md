...
- **Official Homebrew cask / 正式 Homebrew 安装入口** — New installations use `brew install --cask dengmengmian/tap/muxlayer`; the legacy `agentgate` cask remains upgrade-compatible.
- **Native app icon refresh / 原生应用图标更新** — macOS, Windows, Linux, Android, and iOS package assets now use the MuxLayer icon.
