...
| 你的机器 | 下载 |
|---|---|
| macOS Apple 芯片 | [AgentGate_1.6.0_aarch64.dmg](https://github.com/dengmengmian/agentgate-ai/releases/download/v1.6.0/AgentGate_1.6.0_aarch64.dmg) |
| macOS Intel 芯片 | [AgentGate_1.6.0_x64.dmg](https://github.com/dengmengmian/agentgate-ai/releases/download/v1.6.0/AgentGate_1.6.0_x64.dmg) |
...
| 其他 Linux 发行版 | [AgentGate_1.6.0_amd64.AppImage](https://github.com/dengmengmian/agentgate-ai/releases/download/v1.6.0/AgentGate_1.6.0_amd64.AppImage) |
